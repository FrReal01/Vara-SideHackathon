...
impl<'a> TrafficLightService<'a> {
    ...
    pub fn green(
        ...
        self.state.age = age.clone();
        self.state.country = country.clone();
        self.state.luggage = luggage.clone();
        self.state.date_flight = date_flight.clone();
        self.state.lugagge_value = lugagge_value.clone();
